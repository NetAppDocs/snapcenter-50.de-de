...
+
Sie können die Ressourcengruppe durchsuchen, indem Sie den Namen der Ressourcengruppe in das Suchfeld eingeben, oder indem Sie * *image:../media/filter_icon.gif["Filtersymbol"]auswählen und dann das Tag auswählen. Sie können dann * * auswählenimage:../media/filter_icon.gif["Filtersymbol"], um das Filterfenster zu schließen.
