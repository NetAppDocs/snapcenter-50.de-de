...
+
Klicken Sie auf image:../media/filter_icon.png[""] , und wählen Sie den Hostnamen und die SQL Server-Instanz aus, um die Ressourcen zu filtern. Sie können dann klicken image:../media/filter_icon.png[""] , um den Filterbereich zu schließen.
