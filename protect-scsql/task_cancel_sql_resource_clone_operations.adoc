...
Aktivitätsbereich
 a| 
. Klicken Sie nach dem Starten des Klonvorgangs auf image:../media/activity_pane_icon.gif[""] das Teilfenster „Aktivität“, um die fünf letzten Vorgänge anzuzeigen.
