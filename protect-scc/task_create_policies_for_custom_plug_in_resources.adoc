...
Siehe link:task_view_custom_plug_in_resource_backups_and_clones_in_the_topology_page.html["Sehen Sie sich auf der Seite Topologie benutzerdefinierte Backups und Klone zu den Plug-in-Ressourcen an"].
