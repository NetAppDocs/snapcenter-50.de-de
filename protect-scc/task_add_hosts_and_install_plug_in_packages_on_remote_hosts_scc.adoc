...
+
Wenn Sie MySQL oder DB2 Applikationen managen möchten, können Sie die benutzerdefinierten MySQL und DB2 Plug-ins verwenden, die von NetApp zur Verfügung gestellt werden. Die benutzerdefinierten Plug-ins für MySQL und DB2 sind im verfügbar https://automationstore.netapp.com/home.shtml["NetApp Automation Store"]
