...
Aktivitätsbereich
 a| 
.. Nachdem Sie den Sicherungsvorgang gestartet haben, klicken Sie auf image:../media/activity_pane_icon.gif["Symbol im Aktivitätsbereich"]das Aktivitätsfenster, um die fünf letzten Vorgänge anzuzeigen.
