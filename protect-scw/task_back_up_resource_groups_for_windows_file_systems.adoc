...
+
Sie können die Ressourcengruppe durchsuchen, indem Sie den Namen der Ressourcengruppe in das Suchfeld eingeben, oder indem Sie auf klicken image:../media/filter_icon.png[""] und das Tag auswählen. Sie können dann klicken image:../media/filter_icon.png[""] , um den Filterbereich zu schließen.
