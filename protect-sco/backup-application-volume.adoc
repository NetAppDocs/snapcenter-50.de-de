...
+
Sie können dann auf * * klickenimage:../media/filter_icon.png[""], um den Filterbereich zu schließen.
...
+
.. Klicken Sie in der Spalte Zeitpläne konfigurieren auf image:../media/add_policy_from_resourcegroup.gif[""] die Richtlinie, für die Sie einen Zeitplan konfigurieren möchten.
