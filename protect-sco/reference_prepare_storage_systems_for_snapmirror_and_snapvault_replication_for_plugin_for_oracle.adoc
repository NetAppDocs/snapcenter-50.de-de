...
SnapCenter unterstützt die Verwaltung versionsflexibler SnapMirror-Beziehungen. Einzelheiten zu versionsflexiblen SnapMirror-Beziehungen und deren Einrichtung finden sich unter link:http://docs.netapp.com/ontap-9/index.jsp?topic=%2Fcom.netapp.doc.ic-base%2Fresources%2Fhome.html["ONTAP-Dokumentation"^].
