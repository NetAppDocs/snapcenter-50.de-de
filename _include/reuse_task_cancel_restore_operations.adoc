...
Aktivitätsbereich
 a| 
. Nachdem Sie den Wiederherstellungsvorgang gestartet haben, klicken Sie auf image:../media/activity_pane_icon.gif[""] das Aktivitätsfenster, um die fünf letzten Vorgänge anzuzeigen.
