...
. Klicken Sie auf das image:../media/more_icon.gif[""] Symbol und dann auf *Dienst starten* oder *Dienst neu starten*.
+
...
. Klicken Sie auf das image:../media/more_icon.gif[""] Symbol und dann auf *Zeitplan unterbrechen*, um den Host für dieses Plug-in in den Wartungsmodus zu versetzen.
+
