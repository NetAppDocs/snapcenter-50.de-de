...
+
Weitere Informationen zu Windows-Cmdlets finden Sie unter https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmllllll["SnapCenter Software Cmdlet Referenzhandbuch"^].
...
+
Benutzerdefinierte Plug-ins werden von der Community unterstützt und können von der heruntergeladen werden https://automationstore.netapp.com/home.shtml["NetApp Storage Automation Store"^].
...
Benutzerdefinierte Plug-in-Beispiele für MySQL, DB2 und MongoDB für SnapCenter-Software können von der heruntergeladen werden https://automationstore.netapp.com/home.shtml["NetApp Storage Automation Store"^].
